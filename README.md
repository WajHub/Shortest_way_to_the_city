...
The purpose of the project is to familiarize you with the basic tools included in the STL (e.g. string, list). Practical application of the BFS algorithms (to find connections between cities) and Dijkstra's algorithm (to find the shortest path). The folder "Tests" contains sample input and output data.
